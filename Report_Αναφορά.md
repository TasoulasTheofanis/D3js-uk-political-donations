...
#### [Μετάβαση στο προσωπικό αποθετήριο του κώδικα](https://github.com/TasoulasTheofanis/D3js-uk-political-donations)
#### [Μετάβαση στο εκτελέσιμο του κώδικα](https://tasoulastheofanis.github.io/D3js-uk-political-donations/)


### Θέμα εργασίας στο μάθημα Τεχνολογία Λογισμικού
...
##### Παραδοτέο 2      
  ...
  Για το πρώτο ζητούμενο, στο οποίο απαιτούνται αλλαγές στο κοινό αποθετήριο του κώδικα με pull request, χρησιμοποιήθηκε ο κώδικας του στο φάκελο participants, στο κοινό αποθετήριο του κώδικα. Έγινε μια μικρή τροποποίηση αυτού, αντικαθιστώντας τα 3 span class σε 2, βάζοντας το κατάλληλο ονοματεπώνυμο και την κατάλληλη ηλεκτρονική διεύθυνση της εικόνας προφίλ (avatar). Έτσι, προστέθηκε ο νέος κώδικας στην περιοχή που δεσμεύτηκε (μετά από δήλωση δέσμευσης) και δοκιμάσθηκε η εκτέλεση του κώδικα στον αντίστοιχο ιστότοπο του [προσωπικού αποθετηρίου](https://tasoulastheofanis.github.io/D3js-uk-political-donations/participants/)
   ...
   Η ιστοσελίδα αυτού του ζητούμενου βρίσκεται [σε αυτόν το σύνδεσμο](https://ioniodi.github.io/D3js-uk-political-donations/participants/)
   ...
   Ο ιστότοπος αυτού του ζητούμενου βρίσκεται [σε αυτόν το σύνδεσμο](https://tasoulastheofanis.github.io/D3js-uk-political-donations/participants/2015092.html)
...
##### Με την εισαγωγή μικρών εικονιδίων/εικόνων, τώρα εμφανίζεται και το έμβλημα του κάθε δωρητή.
