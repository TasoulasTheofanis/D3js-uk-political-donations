...
var fill = d3.scale.ordinal().range(["#000066", "#000066", "#000066"]);  
...
/*______________________VIEW IMAGE ON CIRCLE__________________________________________*/	
    ...
    .style("top", (parseInt(d3.select(this).attr("cy") - (d.radius+500)) + offset.top) + "px")
		.html(infoBox)
			.style("display","block");
...
/* Paradoteo 1: i create a new message that will be narrated, when someone goes over any circle*/
	...
	d3.select(".tooltip")
 	...
 	.style("top", (parseInt(d3.select(this).attr("cy") - (d.radius+180)) + offset.top) + "px")
		.html(infoBox)
			.style("display","block");
	}
...
$(document).ready(function() {
    ...
    return d3.csv("https://github.com/TasoulasTheofanis/D3js-uk-political-donations/tree/master/data/banklist.csv", display);
